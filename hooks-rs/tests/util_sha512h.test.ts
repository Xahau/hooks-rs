...
const HOOK_NAME = "util_sha512h";

describe("util_sha512h.rs", () => {
  let client: Client;
  let alice: Wallet;
  let bob: Wallet;
  ...
  beforeAll(async () => {
    ...
    // rPDCGgjzM668uNBw6tcVukeTsFiYPjaea8
    alice = Wallet.fromSecret(`shGwfEbDDJvM9NRNp2oVFSt38CRwn`);
    // rQ3XoSEPmA5mwd8qxgc1CmXjgURcW1Z2PA
    bob = Wallet.fromSecret(`snJLbu7HHbviWqVHn7h6aa4vsjWUm`);
  ...
  it(
    "computes sha512h hash of the input string",
    async () => {
